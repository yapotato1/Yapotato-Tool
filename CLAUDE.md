...
```
VERSION = "3.8.3"   # 位于 server.py 第71行
```
...
- 修改版本号：编辑 `server.py` 第 71 行的 `VERSION` 变量
...
--------------------
2026-05-05
新增 B站视频下载支持，FFmpeg 音画合并，Cookie 认证
--------------------
2026-05-12
新增 B站番剧/电影 PGC 支持，音频分离下载
--------------------
2026-05-14 (v3.8.3)
多浏览器支持（便携版 Edge / Chrome / 系统 Edge），FFmpeg 自动下载
--------------------
